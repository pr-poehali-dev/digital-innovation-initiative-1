      ...
      >
        <header className="flex items-start justify-between gap-4 p-5 border-b border-slate-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-base font-semibold text-slate-900">Быстрый риск</h2>
        ...
        <div className="p-5 space-y-5">
          ...
          <label className="block">
            <span className="text-xs text-slate-500 mb-1.5 block">
              Что может случиться <span className="text-violet-600">*</span>
            </span>
            <textarea
              autoFocus
              value={description}
          ...
          <div className="flex items-center gap-2 p-3 rounded-lg bg-slate-50 border border-slate-200">
            <Icon name="Gauge" size={14} className="text-slate-500 flex-shrink-0" />
